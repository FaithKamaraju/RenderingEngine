...
FE::ObjectTransform FE::Object::getTransform()
{
	return this->transform;
}

glm::mat4 FE::Object::getModelMT() const
{
	return this->m_modelMatrix;
}

glm::mat4 FE::Object::getModelMTLocal() const
{
	return this->m_modelMatrixLocal;
}

void FE::Object::setTransform(const ObjectTransform& otherTransform)
{
...
void FE::Object::setPositionLocal(float x, float y, float z)
{
	transform.position = { x,y,z };
	_updateModelMatrix();
}

void FE::Object::setPositionGlobal(float x, float y, float z)
{
	transform.globalPosition = { x,y,z };
	_updateModelMatrix();
}

void FE::Object::setRotationLocal(float pitch, float yaw, float roll)
{
...
void FE::Object::setRotationGlobal(float pitch, float yaw, float roll)
{
...
void FE::Object::setScale(float x, float y, float z)
{
	this->transform.scale = { x, y, z };

	_updateModelMatrix();
}
void FE::Object::setScale(float scale)
{
...
void FE::Object::translateLocal(float x, float y, float z)
{
	transform.position += glm::vec3(x, y, z);
	_updateModelMatrix();
}

void FE::Object::translateLocal(glm::vec3 translateBy)
{
	transform.position += translateBy;
	_updateModelMatrix();
}
void FE::Object::translateGlobal(float x, float y, float z)
{
	transform.globalPosition += glm::vec3(x, y, z);
	_updateModelMatrix();
}

void FE::Object::translateGlobal(glm::vec3 translateBy)
{
	transform.globalPosition += translateBy;
	_updateModelMatrix();
}

void FE::Object::rotateLocal(float pitch, float yaw, float roll)
{
...
void FE::Object::rotateLocal(glm::vec3 rotateBy)
{
...
void FE::Object::rotateGlobal(float pitch, float yaw, float roll)
{
...
void FE::Object::rotateGlobal(glm::vec3 rotateBy)
{
...
void FE::Object::_updateModelMatrix()
{
