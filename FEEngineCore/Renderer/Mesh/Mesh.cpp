...
FE::Mesh::Mesh(std::vector<Vertex> vertices, std::vector<unsigned int> indices)
{
...
//FE::Mesh::Mesh(std::vector<Vertex> vertices)
//{
//    this->vertices = vertices;
//}

//void FE::Mesh::Draw(Shader& shader)
//{
