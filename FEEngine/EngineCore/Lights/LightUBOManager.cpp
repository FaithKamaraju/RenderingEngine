...
FE::LightUBOManager* FE::LightUBOManager::_instance{ nullptr };
std::mutex FE::LightUBOManager::_mutex;

FE::LightUBOManager::LightUBOManager()
{	
...
FE::LightUBOManager* FE::LightUBOManager::GetInstance()
{
...
int FE::LightUBOManager::addPointLightToMemory(std::shared_ptr<PointLight> pointLightPtr)
{
...
int FE::LightUBOManager::addSpotLightToMemory(std::shared_ptr<SpotLight> spotLightPtr)
{
...
void FE::LightUBOManager::updateUBO(std::weak_ptr<FE::PointLight> pointLightPtr)
{
...
void FE::LightUBOManager::updateUBO(std::weak_ptr<FE::SpotLight> spotLightPtr)
{
	if (std::find_if(spotLightsArr.begin(), spotLightsArr.end(), 
...
void FE::LightUBOManager::deleteLight(std::weak_ptr<FE::PointLight> pointLightPtr)
{
...
void FE::LightUBOManager::deleteLight(std::weak_ptr<SpotLight> spotLightPtr)
{
...
void FE::LightUBOManager::resetPointLightMemory(size_t index)
{
...
void FE::LightUBOManager::resetSpotLightMemory(size_t index)
{
